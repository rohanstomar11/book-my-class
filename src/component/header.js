...
import {Text, View, Image, TouchableOpacity, StyleSheet, Platform, Button} from 'react-native';
  ...
  return (
    <View style={styles.rootcontainer}>
      ...
      <View style={styles.secondcont}>
        <TouchableOpacity style={styles.Datecontainer} placeholder ='Select Date' onPress={() => showMode('date')}>
          <Text>Select Date</Text></TouchableOpacity>
      </View>
